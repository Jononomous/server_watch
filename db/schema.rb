...
ActiveRecord::Schema.define(:version => 20130323184654) do
  ...
  create_table "server_infos", :force => true do |t|
    ...
    t.string   "key_file_content_type"
    t.integer  "key_file_file_size"
    t.datetime "key_file_updated_at"
  end
